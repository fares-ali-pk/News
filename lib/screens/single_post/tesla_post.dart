...
class TeslaPost extends StatefulWidget {
  final ArticleTesla _articleTesla;


  TeslaPost(this._articleTesla);

  @override
  _TeslaPostState createState() => _TeslaPostState();
}

class _TeslaPostState extends State<TeslaPost> {
  @override
              ...
              background: Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage(widget._articleTesla.urlToImage),
                      fit: BoxFit.cover),
                ),
              ),
            ),
