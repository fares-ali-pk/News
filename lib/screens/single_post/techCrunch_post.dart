...
class TechCrunchPost extends StatefulWidget {
  final TopTechCrunch _techCrunch;

  TechCrunchPost(this._techCrunch);

  @override
  _TechCrunchPostState createState() => _TechCrunchPostState();
}

class _TechCrunchPostState extends State<TechCrunchPost> {
  @override
              ...
              background: Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage(widget._techCrunch.urlToImage),
                      fit: BoxFit.cover),
                ),
              ),
            ),
